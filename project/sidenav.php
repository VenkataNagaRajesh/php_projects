      ...
      <div class="wrapper">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-items">
               ...
               <li><a href="stock.php"><i class="fa fa-solid fa-capsules"></i>Stock</a></li>
               <li><a href="#"><i class="fas fa-book"></i>Appointment History</a></li>
               <li><a href="#"><i class="fas fa-file"></i>Quries</a></li>
               <li><a href="#"><i class="fa fa-cash-register"></i>Transactions</a></li>
